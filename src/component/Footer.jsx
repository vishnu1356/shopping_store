                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Careers</a>
                                </li>
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Brand Center</a>
                                </li>
                                <li className="mb-4">
                        ...
                        {/* Help Center Section */}
                        <div>
                            <h2 className="mb-6 text-xl font-semibold text-gray-900 uppercase dark:text-white">Help Center</h2>
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Discord Server</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Licensing</a>
                                </li>
                                <li className="mb-4">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Mob:- +91 9105-661-356</a>
                                </li>
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Email:- work.vishnu123@gmail.com</a>
                                </li>
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Skype:- vishnu@whizamet.com</a>
                                </li>
                                <li className="mb-4">
                                    <a href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">WhatsApp:- +91 9105-661-356</a>
                                </li>
                            </ul>
                        </div>

...
function SingleCard() {
    return (
        <>
            <div className='flex justify-center gap-12 flex-wrap cursor-pointer  sm:text-xl'>
                <p className='custom-hover'>All Products</p>
                <p className='custom-hover'>Electronics</p>
                <p className='custom-hover'>Men's Clothing</p>
                <p className='custom-hover'>Women's Clothing</p>
                <p className='custom-hover'>Jewelry</p>
            </div>
            ...
            <div className='flex justify-center flex-wrap gap-8 mt-12 mb-12'>
                <div className="w-full bg-gray-100 hover:shadow-xl max-h-[450px] max-w-xs mt-6  border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="px-4 pb-4">
                        <a href="#">
                            <h5 className=" font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                        </a>
                        ...
                        <div className="flex items-center justify-between">
                            <span className=" font-semibold text-gray-900 dark:text-white">$599</span>
                            <a href="#" className="text-white bg-blue-800 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
                        </div>
                    </div>
                </div>
